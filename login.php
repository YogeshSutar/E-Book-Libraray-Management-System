...
<html>
  ...
  <form class="container loginform" action="login.php" method='POST'>
        ...
        <button type="submit" class="btnreg1">Submit</button>
        <button type="submit" class="btnreg2"><a href="signup.php" style="text-decoration: none;" >signup</a></button>
       <button type="submit" class="btnreg3"> <a  href='forgotpass.php' style="text-decoration: none;">Forget Password</a></button>
